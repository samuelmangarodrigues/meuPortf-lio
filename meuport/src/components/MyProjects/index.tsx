...
function MyProjects() {
    return (
        <Flex justifyContent="center">
            ...
            {/* <Carousel showStatus={false}width={320}>
            <Flex justifyContent='center' margin={17}>
                <Box
                ...
                padding={3}
                 >
                    ...
                    <Flex flexDirection="column">
                        <Habits target="_blank" href="https://habits-1.vercel.app/">
                            Site Habits
                        </Habits>
                        <Habits target="_blank" href="https://github.com/samuelmangarodrigues/habits">
                            <BsGithub/>
                        </Habits>
                    </Flex>
                </Box>
            ...
            <Flex color='white' justifyContent='center' margin={17}>
                <Box
                    ...
                    padding={3}
                    >
                        <Flex alignItems="flex-start" width="100%" wrap="wrap">
                            <ProjectsTechs>JavaScript</ProjectsTechs>
                            <ProjectsTechs>TypeScript</ProjectsTechs>
                            <ProjectsTechs>Reactjs</ProjectsTechs>
                            <ProjectsTechs>ChakraUi</ProjectsTechs>
                        ...
                        <Text margin={5} fontSize={20}>
                        Essa aplicação  visa disponibilizar um incentivo de descarte correto do óleo.
                        Mostrando aos usuários empresas que se interessam nesse tipo de produto.
                        </Text>
                        <Flex flexDirection="column">
                            <Habits target="_blank" href="https://oil-cycle.vercel.app/">
                                Site Oil Cycle
                            </Habits>
                            <Habits target="_blank" href="https://github.com/victornunesc/Oil-Cycle">
                                <BsGithub/>
                            </Habits>
                        </Flex>
                </Box>
            ...
            <Flex color='white' justifyContent='center' margin={17}>
                <Box
                    ...
                    >
                        ...
                        <Text margin={5} fontSize={20}>
                        Essa aplicação tem como objetivo disponibilizar uma maneira prática de locação de embarcações.
                        Possibilitando cadastrar, alugar  e reservar embarcações.
                        </Text>
                        <Flex flexDirection="column">
                            <Habits target="_blank" href="https://github.com/matheus-araujo-cunha/capstone_nodejs">
                                Api Rent Boats
                            </Habits>
                            <Habits target="_blank" href="https://github.com/matheus-araujo-cunha/capstone_nodejs">
                                <BsGithub/>
            ...
            <Flex color='white' justifyContent='center' margin={17}>
                <Box
                    ...
                    >
                        ...
                        <Text margin={5} fontSize={20}>
                        A aplicação foi pensada para divulgação de vagas e assuntos correlatos bem como a criação e manutenção de uma rede formada por mulheres que já atuam ou almejam atuar na área de tecnologia.
                        </Text>
                        <Flex flexDirection="column">
                            <Habits target="_blank" href="https://github.com/LeandroMedvedev/cap-alexandre-g05/tree/main">
                                Api Code_By_Girls
                            </Habits>
                            <Habits target="_blank" href="https://github.com/LeandroMedvedev/cap-alexandre-g05/tree/main">
                                <BsGithub/>
